...
|----------|---------|---------|
| `/api/eventos` | GET / POST / PUT / DELETE | CRUD de Evento |
| `/api/participantes` | GET / POST / PUT / DELETE | CRUD de Participante |
| `/api/inscricaos` | GET / POST / PUT / DELETE | CRUD de Inscricao |
| `/api/credenciamentos` | GET / POST / PUT / DELETE | CRUD de Credenciamento |
